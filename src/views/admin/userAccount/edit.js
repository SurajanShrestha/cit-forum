...
function AdminUpdateUserAccount() {
            ...
            <Container>
                <Row className="px-3">
                    <Col lg={{ span: 6, offset: 3 }} className="single-form">
                        ...
                        <p className="note">
                            <Link to={`/admin/userAccount/${slug}`} className="clickable"><FaUserAlt /> My Account</Link>
                        </p>
                        <p className="note">
                            <Link to="/admin/userAccount/updatePw" className="clickable"><RiLockPasswordFill /> Change Password</Link>
                        </p>
                    </Col>
                </Row>
            </Container >
...
export default AdminUpdateUserAccount;
